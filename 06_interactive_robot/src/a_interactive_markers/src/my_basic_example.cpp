...
int main(int argc, char **argv) {
  ...
  int_marker = get_interactive_marker_msg("my_marker", "base_link",
                                          "desc: Simple 1-dof control",
                                          position, orientation, scale);

  // 3. Instantiate a Box marker to display a box
  visualization_msgs::Marker box_marker = get_gray_box_msg(0.45);
  ...
  non_interactive_control = get_interactive_marker_control_msg(
  ...
  rotate_control = get_interactive_marker_control_msg(
      "move_x", "move along x",
      visualization_msgs::InteractiveMarkerControl::INHERIT,
      visualization_msgs::InteractiveMarkerControl::MOVE_AXIS, orientation,
      true);
